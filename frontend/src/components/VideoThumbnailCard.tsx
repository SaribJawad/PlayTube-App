...
const VideoThumbnailCard: React.FC = () => {
  return (
    <div className=" h-[270px] w-[100%]">
      <div className=" h-[72%] relative rounded-xl overflow-hidden">
        <Link to={""}>
          <img
            ...
            alt=""
          />
          <span className="absolute bottom-2 text-sm bg-black bg-opacity-45 px-[5px] rounded-md right-2 z-10 text-center">
            23:49
          </span>
        </Link>
      </div>
      <div className="h-[28%]  flex items-center gap-2 p-2">
        ...
        <div className="w-[83%] h-full  ">
          ...
          <h2 className=" text-[13px] text-zinc-500">Chai aur code</h2>
